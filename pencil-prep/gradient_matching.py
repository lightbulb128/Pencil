...
if __name__ == "__main__":
    ...
    model_name, model = model.get_model("cifar10_sphinx")
    ...
    noise_levels_name = ["0", "0.0001", "0.0005", "0.001", "0.01"]
    ...
    if not os.path.exists("./gradient-matching/"):
        os.mkdir("./gradient-matching/")
    plt.subplots_adjust(wspace=1e-1, hspace=1e-1)
