...
if __name__ == "__main__":
    ...
    pencil("train_nn3", end_to_end("train_nn3", "cifar10_lenet5"))
    pencil("train_nn4", end_to_end("train_nn4", "cifar10_sphinx"))
    pencil("train_nn5", end_to_end("train_nn5", "alexnet_classifier"))
    ...
    pencil("costs_nn3", costs("costs_nn3", "cifar10_lenet5"))
    pencil("costs_nn4", costs("costs_nn4", "cifar10_sphinx"))
    pencil("costs_nn5", costs("costs_nn5", "alexnet_classifier"))
